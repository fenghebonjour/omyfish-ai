...
Used as fallback when no trained EfficientNet checkpoint is available.
"""
...
from predictors.base import BaseFishPredictor
...
class CLIPFishPredictor(BaseFishPredictor):
    def __init__(self, metadata_path: str = "/metadata/fish_info.json"):
    ...
    def _build_text_embeddings(self) -> torch.Tensor:
        ...
        return torch.stack(species_embeddings)
